...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='/home/peter/workspace/dataset/NTURGB+D/nturgb+d_skeletons')
    parser.add_argument('--ignored_sample_path',
                        default='/home/peter/workspace/dataset/NTURGB+D/nturgb+d_skeletons')
    ...
    f = arg.data_path + '/S017C003P020R002A040.skeleton'
    a = read_xyz(f)
    print(a.shape)
    print(a[:,0,:,0])
